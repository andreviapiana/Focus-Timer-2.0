...
Como parte da minha criação livre realizei a adição da reponsividade, além da inserção de backgrounds customizados e sliders de volume individuais para cada botão. O JavaScritp foi todo separado em arquivos individuais, gerando um desafio a mais.
